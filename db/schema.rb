...
ActiveRecord::Schema.define(version: 2018_05_30_165024) do
  ...
  create_table "carts_items", id: false, force: :cascade do |t|
    ...
    t.integer "added_item_id", null: false
    t.index ["added_item_id"], name: "index_carts_items_on_added_item_id"
